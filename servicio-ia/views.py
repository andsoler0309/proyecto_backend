...
GESTOR_INCIDENTES_BASE_URL = os.environ.get("GESTOR_INCIDENTES_BASE_URL", "http://localhost:5001")
...
class Chatbot(Resource):
    def post(self):
        ...
        if message == "start":
            ...
            return {"msg": f"Hola, bienvenido al chatbot de incidentes, porfavor selecciona el numero de la empresa a la cual quieres registrar un incidente:\n{companies_numbered}", "chatbot_conversation_id": chatbot_conversation.id}, 200
        else:
            try:
        ...
        if chatbot_state == ChatbotState.COMPANY_NAME_SELECTION:
            ...
            return {"msg": "listo, ahora porfavor describe el incidente que quieres registrar"}, 200
        ...
        if chatbot_state == ChatbotState.DESCRIPTION:
            ...
            try:
                ...
                db.session.rollback()
                return {"msg": "Error updating chatbot conversation"}, 500
            return {"msg": f"Entendido, quieres registrar el incidente con la siguiente descripción: {message}?"}, 200
        ...
        if chatbot_state == ChatbotState.CONFIRM:
            if message.lower() == "si":
                ...
                return {"msg": "Porfavor ingresa tu numero de identificacion sin espacios ni puntos"}, 200
            else:
                chatbot_conversation.state = ChatbotState.DESCRIPTION
                db.session.add(chatbot_conversation)
                try:
                ...
                return {"msg": "Porfavor describe el incidente que quieres registrar"}, 200
